...
public class Main {
    ...
    public static void main(String[] args) throws Exception{
            ...
            System.out.println(institut1.obtenirNom());

            // Persona
            Persona persona1 = new Persona();
            persona1.canviarNomPersona("Joe");
            persona1.assignarDni("66655544J");
            System.out.println(persona1.obtenirDades());
            ...
            System.out.println(professorSubstitut1.obtenirDades());
            ...
            //System.out.println(persona3.obtenirDades());

            Persona persona4 = new Persona();
            persona4.assignarDni("64973152P");
            //System.out.println(persona4.obtenirDades());
    }
